...
```{r fem-education-linreg}
mainfit <- linear_reg() %>%
  set_engine("lm") %>%
  fit(Adolescent_Birth_Rate ~ Secondary_Education_Female + Mean_Years_Schooling_Male + Mean_Years_Schooling_Female + Secondary_Education_Male +  Mean_Years_Schooling_Male*Mean_Years_Schooling_Female, data = fem_education)
...
The gender equality index measures the gender disparity in a country on a scale from 0 to 1. The greater the value, the greater the measure of inequality.

...
```
From this, we see that the middle 50% of countries have a teenage birth rate between __ and __. Considering a high birth rate is 40-50 births per 1,000 women, our boxplot shows a distribution of relatively low and high rates. We also have a few outliers, including __, ___, and ___.
```{r quantile}
country_joined %>%
quantile(as.numeric(`Adolescent Birth Rate`), probs = seq(0, 1, 0.25))
```

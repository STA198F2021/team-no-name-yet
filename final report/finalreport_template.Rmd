...
# Introduction
Our group chose to research what influences the rates of teenage pregnancies because we consider premature pregnancies one of the most significant indicators of a country’s development and prosperity. Therefore, we hope our findings can encourage governments to reduce the rate of teenage pregnancies, especially considering the repercussions of lost economic contributions and increased dependency on costly public programs [https://www.ncbi.nlm.nih.gov/books/NBK219229/]. 

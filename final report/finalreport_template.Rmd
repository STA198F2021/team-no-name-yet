...
ggplot(data = cat_new) +
  ...
  labs(x = "Gender Inequality Index", 
       ...
       color = "HDI Category")
```
HDI reflects economic prosperity in a country, so we broke the HDI rankings up into four categories to ___. This plot supports the idea that wealthier countries tend to have lower gender equality disparities and lower rates of teen births, and vice versa.

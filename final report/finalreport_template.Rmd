...
#Join
```{r}
data_joined <- hdi1_clean %>%
  inner_join(hdi1_clean, hdi10_clean, by = "HDI Rank")

data_joined <- data_joined %>%
  inner_join(data_joined, hdi4_clean, by = "HDI Rank")

data_joined <- data_joined %>%
  inner_join(data_joined, hdi5_clean, by = "HDI Rank")

data_joined <- data_joined %>%
  inner_join(data_joined, hdi8_clean, by = "HDI Rank")
```

...
#adolescent_births_clean <- slice(adolescent_births, -c(1:7, 74, 128, 166, 200, 207:270))
#adolescent_births_clean <- select(adolescent_births_clean, select = -c(X.1, X.3, X.5, X.7, X.9, X.11))
#names(adolescent_births_clean) <- c("HDI Rank", "Country", "HDI 2019", "Life Expectancy Birth", "Expected Years Schooling", "Mean Years Schooling", "GNI Per Capita", "GNI Per Capita Minus HDI", "HDI 2018")
```

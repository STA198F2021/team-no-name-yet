...
hdi_joined <- hdi1_clean %>%
  inner_join(hdi10_clean, by = "HDI Rank")%>%
  inner_join(hdi4_clean, by = "HDI Rank")%>%
  inner_join(hdi5_clean, by = "HDI Rank")%>%
  inner_join(hdi8_clean, by = "HDI Rank")
...
**Is HDI related to adolescent birth rate?**
#fig7

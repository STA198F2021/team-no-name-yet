...
#You will need to download another library for references.bib to run! ^^^^^^^^
---
...
## Chi Squared Test
```{r}
'labour_chisq_statistic <- country_joined %>%
  specify(as.numeric(`Labour Participation Female`) ~ as.nummeric(`Adolescent_Birth_Rate`)) %>%
  calculate(stat = "Chisq")

GII_chisq_statistic <- country_joined %>%
  specify(Gender_Inequality_Index ~ Adolescent_Birth_Rate) %>%
  calculate(stat = "Chisq")'
```

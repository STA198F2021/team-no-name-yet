...
```{r}
country_joined %>%
  ggplot(aes(x = as.numeric(`HDI Rank.x`)))+
  geom_density()
```
...
#   )
=======
>>>>>>> 6cf5209ec2f9702cfa8f18c26debe74a7fc1787a
...
ggplot(country_joined, aes(x = as.numeric(`Life Expectancy Birth Male`), 
  ...
  geom_point()+
  labs(
    title= "Is Male Life Expectacy at Birth Related to Adolescent Birth Rate?",
    x="Male Life Expectacy at Birth",
    y="Adolescent Birth Rate"
  )
```

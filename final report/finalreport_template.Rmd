...
ggplot(data = cat_new) +
  ...
  labs(x = "Gender Inequality Index", 
       ...
       color = "HDI Category")
```
High HDI reflects a high economic prosperity in a country. We broke the HDI rankings up into four categories. This plot supports the idea that wealthier countries have lower gender equality desparities and lower rates of teen births.

...
- As maternal mortality increases, so does adolescent birth rate across countries.  
   
- We expect countries with higher adolescent birth rates to have high maternal mortality ratios due to premature bodies and lack of access to modern healthcare (among other factors).]. 
...
.pull-right[
- Relatively strong, negative, linear correlation  
  - r = -0.7249  
  
- As the mean years of schooling for women increases, the rate of adolescent births decreases. 
  
- Makes sense because the increase in time spent in school increases the likelihood of a woman finding a career in the workforce along with being actively informed about sexual health and safe practices.]  
